...
const Process3 = () => {
  ...
  return (
    <>
      ...
      <StyledParagraph3>
        <EditableButton
          isSelected={selectedButton === "초등교육"}
          onClick={() => handleButtonClick("초등교육")}
        >
          초등교육
        </EditableButton>
      </StyledParagraph3>
      <StyledParagraph4>
        <EditableButton
          isSelected={selectedButton === "중등교육"}
          onClick={() => handleButtonClick("중등교육")}
        >
          중등교육
        </EditableButton>
      </StyledParagraph4>
      <StyledParagraph5>
        <EditableButton
          isSelected={selectedButton === "고등교육"}
          onClick={() => handleButtonClick("고등교육")}
        >
          고등교육
        </EditableButton>
      </StyledParagraph5>
