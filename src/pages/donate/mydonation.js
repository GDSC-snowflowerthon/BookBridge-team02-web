...
const Hello = () => {
    ...
    <>
        ...
        {
            arrs.map((arr, index) => (
            <ListItem pageTypeNormal={true} pageTypeDetail='PostOtherUser' name={arr.name} school={arr.school} subject={arr.subject} date={arr.date} matching={arr.matching} imgSrc={arr.imgSrc} key={index}/>
            ))
        }
        </ul>
        </PostBg>
